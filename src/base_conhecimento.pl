...
encomenda(  7,  4,  4,  4,  9,  'Rua da Piedade',           'Alges',                validaData(2020,11,22,12),  validaData(2020,11,22,12),  0,  1,  2,  1 ).
encomenda(  8,  10, 4,  10, 7,  'Rua do Pombal',            'S.Vicente',            validaData(2020,9,15,9),    validaData(2020,9,16,9),    1,  4,  3,  7 ).
encomenda(  9,  9,  2,  9,  5,  'Rua Da Lage',              'Gualtar',              validaData(2020,8,17,10),   validaData(2020,8,24,10),   7,  2,  1,  8 ).
encomenda(  10, 7,  1,  7,  69, 'Rua Jacinta Marto',        'Fátima',               validaData(2020,7,27,20),   validaData(2020,7,28,20),   6,  5,  2,  23).
encomenda(  11, 6,  3,  1,  15, 'Rua Jacinta Marto',        'Fátima',               validaData(2020,7,27,18),   validaData(2020,7,28,0),    6,  5,  2,  23).
